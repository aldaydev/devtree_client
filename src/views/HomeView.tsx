    ...
    return (
        <>
            <main className="bg-gray-100 lg:py-10 pb-14 pt-4 min-h-[calc(100dvh-85px)] bg-no-repeat lg:bg-home lg:bg-home-xl bg-right-top px-[10%] res-padding">
                ...
                <h1 className="text-4xl text-center text-balance font-black lg:text-4xl mb-8 w-[60%] mx-auto">
                ...
                <div className="flex items-center justify-center flex-col lg:flex-row gap-10">
                    ...
                    <div className="basis-[50%] flex flex-col gap-4">
                        <p className="text-slate-800 text-2xl mb-5">Spotify, Youtube, Amazon Music, Instagram y todos los enlaces que necesitas para compartir tu proyecto musical con el mundo</p>

                        <p className="text-slate-800 text-2xl font-bold">¿Cómo funciona?</p>
                    ...
                    <img src="/mlink_illustration.svg" className="w-[100%] lg: basis-[60%] first-letter:w-full h-auto object-cover max-w-[300px] lg:max-w-[500px] " />
